...
const UNIVERSITY_DATES = [
    { date: '2026-07-20', event: 'Start of lectures: Semester 2', type: 'university' },
    { date: '2026-08-10', event: 'Public Holiday', type: 'university' },
    { date: '2026-09-08', event: 'Start of lectures: Q4', type: 'university' },
    { date: '2026-09-16', event: 'UP Wellness Day — no lecture day', type: 'university' },
    { date: '2026-09-24', event: 'Public Holiday', type: 'university' },
    { date: '2026-11-06', event: 'Lectures end: Semester 2 / pre-exam study period', type: 'university' },
    { date: '2026-12-05', event: 'End of academic year', type: 'university' },
];

// ── RECESS / NON-LECTURE PERIODS ──
const RECESS_RANGES = [
    { start: '2026-09-17', end: '2026-09-27', label: 'September Recess' },
];

const TEST_WEEK_RANGES = [
    { start: '2026-08-22', end: '2026-08-29', label: 'Test Week 1' },
    { start: '2026-09-05', end: '2026-09-05', label: 'Test Week 1 (cont.)' },
    { start: '2026-10-10', end: '2026-10-17', label: 'Test Week 2' },
    { start: '2026-10-24', end: '2026-10-24', label: 'Test Week 2 (cont.)' },
];

const EXAM_RANGE = { start: '2026-11-07', end: '2026-11-25' };
